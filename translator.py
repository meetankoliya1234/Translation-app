...
label1 = Label(root, text = 'Enter Words :', font = ('time','15','italic bold'), bg = 'turquoise1')
label1.place(x = 5, y = 40)

label2 = Label(root, text = 'Translated :', font = ('time','15','italic bold'), bg = 'turquoise1')
label2.place(x = 5, y = 100)

label3 = Label(root, text = '', font = ('time','15','italic bold'), bg = 'turquoise1')
label3.place(x = 10, y = 250)

########################################################## Buttons
imgb1 = PhotoImage(file = 'touch.png')
imgb2 = PhotoImage(file = 'logout.png')

imgb1 = imgb1.subsample(10,10)
imgb2 = imgb2.subsample(10,10)

btn1 = Button(root, text = 'click', bd =10, bg = 'yellow', activebackground = 'red', width = 100, font = ('time','15','italic bold'),
              image = imgb1, compound = RIGHT, command = tt)
btn1.place(x = 70, y = 170)

btn2 = Button(root, text = 'Exit',bd =10, bg = 'yellow', activebackground = 'red', width = 100, font = ('time','15','italic bold'), 
              image = imgb2, compound = RIGHT, command = main_exit)
